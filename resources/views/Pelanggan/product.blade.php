    ...
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/productpelanggan">Product</a>
                            </li>
                            <li class="nav-item">
...
<section class="best product py-5 mt-4 bg-dark">
    <div class="container">
    <h2 class="text-center fw-bold text-success">Games</h2>
<div class="row">
